      ...
      <div class="container">
        <div class="columns mt-5">
          ...
          <div class="column has-text-centered mb-6">
            <div>
              <img src="~assets/img/burner-phone.png">
            </div>
          </div>
        </div>
        <div class="my-6 py-6 has-text-centered has-background-gradient">
          <h2 class="title is-2 mb-6" data-aos="fade-right">
            Get yours for<br><span class="has-text-accent">0 SOL</span>
          </h2>
          <p class="has-limited-width-small is-horizontal-centered" data-aos="fade-up">
            We don’t do minting fees – a Burner Phone costs exactly 0 SOL.
            Are you a Nosana Network user? Stake $NOS for a chance to get your very own.
          </p>
        ...
        <div class="columns py-6 is-vcentered mt-6">
          ...
          <div class="column is-5" data-aos="fade-left">
            ...
            <p class="block">
              The cell phone is an object so entwined with our daily lives,
              we thought it deserved its own metaverse counterpart.
              Our NFT isn’t just any cell phone, though, it’s a burner phone.
              An off-the-grid, disposable item that represents anonymity.
              Perfect for those who dream of a decentralized future – like us.
            </p>
          </div>
        </div>
        <div class="columns  is-vcentered">
          <div class="column is-5" data-aos="fade-right">
            ...
            <p class="block">
              ...
              To celebrate, we’ve held a mint pass lottery and have distributed 50 mint passes – which can be used to mint a Burner Phone in our NFT vending machine.
              You can read about our first lottery [here.](https://nosana.medium.com/nosana-mint-pass-lottery-3298a3c70c89)
            </p>
          </div>
          <div class="column is-5 is-offset-2" data-aos="zoom-in">
            <img src="~assets/img/nos-machine.png">
          </div>
        </div>
        ...
        <div class="columns py-6 is-vcentered mt-6">
          <div class="column is-7" data-aos="zoom-in">
            <img src="~assets/img/burner-phones.png">
          </div>
          <div class="column is-5" data-aos="fade-left">
            <h2 class="title">
