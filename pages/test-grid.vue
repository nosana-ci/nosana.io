      ...
      <div class="container">
        ...
        <div class="columns mt-5">
          <div class="column is-5" data-aos="fade-up">
            ...
            <div class="has-limited-width-small mt-4">
              <p class="block">
                The aim of our GPU compute grid is to provide a scalable, cost-efficient solution for AI computations,
                foster market innovation and meet the growing demand for advanced, energy-efficient GPUs.
                Register to take part and access complimentary, on-demand compute.
                <br>
              </p>
              <p class="block">
                <a
      ...
      <div class="container">
        <div class="mt-6 py-6 has-text-centered ">
          ...
          <p class="has-limited-width-small is-horizontal-centered">
            During the first two phases of the Test Grid you will require an NVIDIA GPU with CUDA.
  ...
  data () {
    return {
      faqs: [
        ...
        { question: 'How do I register for the Test Grid?', answer: 'Follow the in-depth tutorial found here: <a href="https://docs.nosana.io/nodes/testgrid.html" target="_blank">https://docs.nosana.io/nodes/testgrid.html</a> to register your GPU hardware on the Nosana Network.' },
        { question: 'Do I need a blockchain wallet?', answer: 'No, the Nosana Node will create one for you. You will be required to send it a small amount of SOL to operate as a node. If you wish to use your own keypair file, and have the necessary knowledge to do this, please refer to the advanced documentation in the tutorial to use your own keypair with the Nosana Node.' },
        { question: 'How do I know if I’m selected for the Test Grid?', answer: 'We will selectively onboard new participants into the Test Grid based on market requirements and ability of your hardware to run advanced AI models All nodes selected for onboarding will be announced in our Discord server only. Please join our Discord server here: <a href="https://discord.gg/Nosana-AI" target="_blank">https://discord.gg/Nosana-AI</a> to receive updates.' },
        { question: 'What kinds of tests will I need to do?', answer: 'During the Incentivized GPU Test Grid there will be a selection of markets running various AI workloads.  These workloads may include generic stress and performance test, light workloads, and more robust workloads for higher powered GPU’s.' },
        ...
        { question: 'How long will Phase 2 last?', answer: 'Phase 2 is expected to run through July 2024 - but can be extended based on the distributed rewards' }
      ]
    };
  }
};
