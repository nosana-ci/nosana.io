<template>
  <div class="box p-0 mt-6 has-border-accent has-background-image mountain-grid">
    <div class="has-limited-width p-6">
      <div class="p-3">
        ...
        <p class="mt-4">
          <a href="https://docs.nosana.com" class="is-underlined"><strong class="has-text-accent">Explore the docs &nbsp;&nbsp;↘</strong></a>
        </p>
      </div>
    </div>
  </div>
